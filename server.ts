...
const decFallback = "AQ.Ab8RN6KBnuiBBDQBVGIVb5oC0PmBvoVb2GyIlPLHh_pj8Ma9Hw";
...
if (apiKey) {
  ...
  console.log("[Gemini] No GEMINI_API_KEY found. Using Heuristic NLP fallback as default engine.");
}
